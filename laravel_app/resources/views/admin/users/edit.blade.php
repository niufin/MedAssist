                    ...
                    <form method="POST" action="{{ route('admin.users.update', $user->id) }}">
                        ...
                        <div class="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="designation" type="text" name="designation" value="{{ old('designation', $user->designation) }}">
                            </div>
                            <div>
                                <label class="block text-gray-700 text-sm font-bold mb-2" for="additional_qualifications">Additional Courses / Diplomas</label>
                                <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="additional_qualifications" type="text" name="additional_qualifications" value="{{ old('additional_qualifications', $user->additional_qualifications) }}">
                            </div>
                            <div>
